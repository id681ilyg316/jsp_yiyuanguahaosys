...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
	...
	<form action="<%=basePath %>Member?method=UPREGINFO" name="regform" onSubmit="return checkpersonreg()">
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  ...
		  <TR align="center" bgColor=#ffffff>
			<TD width="45%" align="right" >真实姓名：</TD>
		  ...
		  <TR align="center" bgColor=#ffffff>
			<TD width="45%" align="right" >性 别：</TD>
			<TD  align="left" id=map>
		  ...
		  <TR align="center" bgColor=#ffffff>
			<TD width="45%" align="right" >籍 贯：</TD>
			<TD  align="left" id=map>
		  ...
		  <TR align="center" bgColor=#ffffff>
			<TD width="45%" align="right" >联系电话：</TD>
			<TD  align="left" id=map>
		  ...
		  <TR align="center" bgColor=#ffffff>
			<TD width="45%" align="right" >E-mail：</TD>
			<TD  align="left" id=map>
		   ...
		   <TR align="center" bgColor=#ffffff>
			<TD width="45%" align="right" >密码提示问题：</TD>
			<TD  align="left" id=map>
