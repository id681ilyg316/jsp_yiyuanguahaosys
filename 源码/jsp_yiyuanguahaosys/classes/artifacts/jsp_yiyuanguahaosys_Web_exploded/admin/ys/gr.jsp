...
<%
	...
	if(username==null){
		...
		String id=""; 
		if(method.equals("upys2")){
			id=request.getParameter("id") ;
			List newsList=cb.get1Com("select * from ys where bh='"+username+"'",10);
...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
  <tr bgcolor='#FFFFFF'> 
    ...
    <td><input name="bh" type="text"  size="40" maxlength="100" value="<%=bh %>" readonly> </TD>
  </tr> 
