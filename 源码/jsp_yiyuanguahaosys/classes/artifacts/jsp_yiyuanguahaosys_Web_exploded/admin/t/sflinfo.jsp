...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    String ksj=request.getParameter("ksj");String esj=request.getParameter("esj");   float sum=0;
 
    		cb.setEVERYPAGENUM(12);
			int cou = cb.getMessageCount("select count(*) from gh where sj>='"+ksj+"' and sj<='"+esj+"'");//得到信息总数			        
			...
			List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from  gh where sj>='"+ksj+"' and sj<='"+esj+"' order by id desc",11);
			...
			if(!pagelist3.isEmpty()){
				for(int i=0;i<pagelist3.size();i++){
					...
					sum+=Float.parseFloat(pagelist2.get(10).toString());
			%> 
