      ...
      <table width="380" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          ...
          <td> 
            ...
            </table><form action="<%=basePath %>Admin" name=form1 method=post onSubmit="return checkform(form1)" autocomplete="off">
            <table width="260" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr> 
                ...
                <td width="106"  height="36">登录帐号</td>
                <td><input type="text" name="username"  size="15" /></td>
              </tr>
              <tr> 
                <td class="nwes" height="36">&nbsp; </td>
                <td   height="36">登录密码</td>
                <td><input type="password" name="password" size="15" /></td>
              </tr>
              <tr> 
                <td width="5" class="nwes" height="36"></td>
                <td width="106"  height="36">用户身份</td>
                <td><select name=sf> 
